...
import "./trendingpropertylist.scss";
...
const TrendingPropertyList = () => {
  ...
  // console.log(`trendingProperties`, trendingProperties);
  return (
    <>
      <Navbar />
      <ScrollButton />
                        ...
                        {/* <div className="property-card">
                          ...
                          <div className="property-grid-layout-container">
                            ...
                            <span className="property-address">
                              2 BHK Independent Floor in Sohna Road
                            </span>
                        ...
                        <div className="card-list">
                          <div style={{ display: "flex", width: "100%" }}>
                            ...
                            <div className="card-list-container">
                              ...
                              >
                                Godrej properties, one of the oldest veterans of
                                the realty sector in India have recently
                                residential in Gurgaon read more
                              </p>
